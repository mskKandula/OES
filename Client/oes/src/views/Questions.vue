<template>
  <div class="main-content">
    <div id="examId">
        <h1>Online Exam</h1>
        <hr>
        <button  class="btn btn-primary" v-on:click = "key= !key">Virtual keyboard</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div v-for="(question, index) in users" :key=index>
            <div v-show="index === questionIndex">
                ...
                <br>
                    ...
                    <button class="btn btn-theme btn-rounded mx-auto" v-if="questionIndex > 0" v-on:click="prev">
                    prev
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button  class="btn btn-theme btn-rounded mx-auto" v-if="questionIndex < users.length - 1 " v-on:click="next">
                    next
                    </button>
                    <button  class="btn btn-theme btn-rounded mx-auto" v-if="index== users.length - 1" @click="submitAnswer">
                    Submit
                    </button>
        ...
        <SimpleKeyboard v-if ="this.key" @onChange="onChange" @onKeyPress="onKeyPress" :input="input"/>
 ...
 methods: {
    ...
    submitAnswer()
    {
      let self = this
        ...
        console.log("93",self.answer)
       self.res = this.$go.countser(JSON.stringify({ans : self.answer}))
     console.log("95",self.res)
 if (self.res){
   self.$router.push({name :'Counter',params:{count : self.res}} )
 }
    },
    onChange(input) {
